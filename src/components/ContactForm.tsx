        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 relative">
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-gray-600">
              Hola, introduce tus datos de contacto para empezar
            </p>
          </div>
              ...
              <div className="flex gap-2">
                <div className="relative w-40">
                  <select
                    ...
                    onChange={handleChange}
                    className="w-full pl-3 pr-8 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent appearance-none"
                  >
