...
import { MessageCircle, Send, Search, X, User, ArrowLeft, Check, CheckCheck, Paperclip, File, Image as ImageIcon, FileText, Download, Megaphone } from 'lucide-react';
...
export function Messages() {
  ...
  return (
    <div className="h-[calc(100vh-140px)] flex relative">
      {/* Lista de conversaciones - Sidebar siempre visible en desktop */}
      <div className={`
        ...
        <div className="p-4 border-b border-gray-200">
          <div className="flex items-center justify-between mb-3">
            ...
            <button
              ...
              title={showUserSearch ? "Cerrar búsqueda" : "Buscar nuevo usuario"}
            >
        ...
        <div className="flex-1 flex flex-col bg-gray-50">
          ...
          <div className="sticky top-0 z-10 bg-white border-b border-gray-200 shadow-sm p-4">
            <div className="flex items-center justify-between gap-3">
              ...
              {/* Botón volver (móvil) - Al lado derecho */}
              <button
                onClick={() => setSelectedConversation(null)}
                className="md:hidden flex items-center gap-1.5 px-3 py-2 bg-primary-600 text-white rounded-lg hover:bg-primary-700 active:bg-primary-800 transition-colors shadow-sm font-medium text-sm flex-shrink-0"
              >
